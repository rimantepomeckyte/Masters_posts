...
@section('content')
    ...
    <form method="post" action="/store" enctype="multipart/form-data" class="mt-2"><!--encytype kad moketu atskirti faila-->
        {{csrf_field()}}
        <div class="form-group row d-flex justify-content-center align-items-center ml-5">
            <label for="company" class="col-lg-2 col-md-3 align-self-center font-weight-bold">Įmonės pavadinimas:</label>
        ...
        <div class="form-group row d-flex justify-content-center align-items-center ml-5">
            <label for="specialization" class="col-lg-2 col-md-3 align-self-center font-weight-bold">Specializacija:</label>
        ...
        <div class="row d-flex justify-content-center">
            <div class="form-group col-4">
                ...
                <input type="text" name="first-name" class="form-control" id="first-name" placeholder="Vardas" value="{{old('first-name')}}">
            </div>
            <div class="form-group col-4">
                <label for="last-name" class="font-weight-bold">Pavardė:</label>
                <input type="text" name="last-name" class="form-control" id="last-name" placeholder="Pavardė" value="{{old('last-name')}}">
            </div>
        </div>
        <div class="row d-flex justify-content-center">
            <div class="form-group col-4">
            ...
            <div class="form-group col-4">
                ...
                <input type="text" name="city" class="form-control" id="city" placeholder="Miesto pavadinimas" value="{{old('city')}}">
            </div>
        ...
        <div class="form-group row d-flex justify-content-center">
            <div class="col-8">
                ...
                <textarea name="master-description" class="form-control" id="master-description" rows="3">{{ old('master-description') }}</textarea>
            </div>
        </div>
        <div class="form-group row d-flex justify-content-center">
            <div class="col-8">

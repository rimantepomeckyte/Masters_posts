...
@section('content')
    <div class="mt-5 pt-5">
        ...
        <form method="post" action="/addingSpecialization" class="row d-flex justify-content-center">
            ...
            <input type="text" name="specialization" class="form-control col-lg-5 col-md-8 align-self-center"
                   id="specialization" placeholder="Įveskite specializacijos pavadinimą...">
